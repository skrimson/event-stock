...
def train():
    ...
    with open("./input/model_gru.json", "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    model.save_weights("./input/model_gru.h5")
...
def test():
    ...
    # Load model, weights
    json_file = open('./model/model_gru.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    loaded_model.load_weights("./model/model_gru.h5")
